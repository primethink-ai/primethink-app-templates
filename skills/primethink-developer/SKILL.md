...
> Portal, focused Live App, and CLI copies under `references/` are generated by `build_skill_references.py`; do not hand-edit them. `references/developer-guide/{compiled-live-apps,responsive-live-apps}.md`, `libraries/`, and `SKILL.md` are maintained by hand.
