...
For detailed information about file storage hierarchy and access control, see [File Storage Hierarchy](File-Storage-Hierarchy.md).
...
See [File Storage Hierarchy](File-Storage-Hierarchy.md) for details on access control and storage locations.
...
- See [File Storage Hierarchy](File-Storage-Hierarchy.md) for details about `@public` and `@liveapp` paths
